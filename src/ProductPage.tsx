...
export const ProductPage = (props: props) => {
    ...
    return (
        <div className="slds-card slds-p-around--large">
            <div>
                <button
                    className="slds-button slds-float_left slds-button_neutral"
                        ...
                        {data.product.information &&
                            info.map((section: string, index: any) => {
                                ...
                                return (
                                    <div
                                        key={index}
                                        className="slds-col slds-box slds-p-around--medium"
                                    >
                                        <h4 className="slds-text-heading_small">
                                            {i}
                                        </h4>
                                        {index && (
                                                ...
                                                {j.length > 1 &&
                                                    j.map((text, index) => {
                                                        return index ? (
                                                            <p
                                                                key={index}
                                                                className="slds-text-body_regular slds-text-align_left"
                                                            >
                                                                {text}
                                                            </p>
                                                        ) : (
